...
gsap.from('.about__img', {opacity: 0, duration: 2, delay: 4.5, x: 60})

// gsap.from('.about__info', {opacity: 0, duration: 3, delay: 6, y: 25})
// gsap.from('.anime-text', {opacity: 0, duration: 3, delay: 6, y: 25, ease:'expo.out', stagger: .3})
